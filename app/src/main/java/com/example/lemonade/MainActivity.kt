...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        val lemonadeImage: ImageView = findViewById(R.id.image_lemon_state)
        val drawImage: Drawable? = when(lemonadeState){
            SELECT -> getDrawable(R.drawable.lemon_tree)
            SQUEEZE -> getDrawable(R.drawable.lemon_squeeze)
            DRINK -> getDrawable(R.drawable.lemon_drink)
            RESTART -> getDrawable(R.drawable.lemon_restart)
            else -> getDrawable(R.drawable.lemon_tree)
        }
        val textMessage: String? = when(lemonadeState){
            ...
            else -> getString(R.string.lemon_select)
        }
        lemonadeImage.setImageDrawable(drawImage);
        textAction.setText(textMessage)
    }
    ...
    private fun setViewElements() {
        ...
        val drawImage: Drawable? = when(textAction.text){
            getString(R.string.lemon_squeeze) -> getDrawable(R.drawable.lemon_squeeze)
            getString(R.string.lemon_drink) -> getDrawable(R.drawable.lemon_drink)
            getString(R.string.lemon_empty_glass) -> getDrawable(R.drawable.lemon_restart)
            else -> getDrawable(R.drawable.lemon_tree)
        }
